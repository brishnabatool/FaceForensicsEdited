...
def test_full_image_network(video_path, model_path, output_path,
    ...
    if model_path is not None:        
        ...
        model = torch.load(model_path , map_location=torch.device('cpu'))    # Brishna: attempting to un-enforce default cuda)
    ...
    print('\n' + video_fn + ': real frames = ' + str(realCount) + ' fake frames = ' + str(fakeCount) + ' ; total frames = ' + str(realCount + fakeCount) + ' ; P(fake) = ' + str(fakeCount/(realCount+fakeCount)))
    resultFile.write('\n' + video_fn + ': real frames = ' + str(realCount) + ' fake frames = ' + str(fakeCount) + ' ; total frames = ' + str(realCount + fakeCount) + ' ; P(fake) = ' + str(fakeCount/(realCount+fakeCount)))
