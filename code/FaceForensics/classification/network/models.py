...
def return_pytorch04_xception(pretrained=True):
    ...
    if pretrained:
        ...
        state_dict = torch.load(
            ...
            '/mnt/data/Work/LUMS/DeepFake/FaceForensics/models_dwld/xception-b5690688.pth')
            # '/mnt/data/Work/LUMS/DeepFake/FaceForensics/models_dwld/resnet18-5c106cde.pth')
